...
Route::get('/blogs/seach/',[FrontendController::class,'bogs_search'])->name('frontend.search');
...
Route::post('/ai-generate-seo', [BlogController::class, 'generateAISeo'])
    ->name('admin.ai.generate.seo');
...
Route::get('/admin/product/store',[ProductController::class,'store'])->name('admin.product.store');
