...
<div class="otp-box">
    ...
    <form action="{{ route('admin.login.passcode') }}" method="post">
      @csrf
        ...
        <input type="number" name="otp" id="finalOtp" 
       style="
       width: auto; 
       height: 60px; 
       text-align: center; 
       ...
       outline: none; 
       transition: all 0.3s;"
       onfocus="this.style.borderColor='#ff5500'; this.style.boxShadow='0 0 0 3px rgba(255,85,0,0.1)';"
       onblur="this.style.borderColor='#ddd'; this.style.boxShadow='none';"
       >

        <input type="hidden" name="otp_privice" value="{{$otp}}">
